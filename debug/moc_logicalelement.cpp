...
QT_MOC_LITERAL(1, 15, 7), // "itemPtr"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "LogicalElement*"
QT_MOC_LITERAL(4, 40, 3) // "ptr"

    },
    "LogicalElement\0itemPtr\0\0LogicalElement*\0"
    "ptr"
};
...
void LogicalElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemPtr((*reinterpret_cast< LogicalElement*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< LogicalElement* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (LogicalElement::*)(LogicalElement * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogicalElement::itemPtr)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogicalElement::itemPtr(LogicalElement * _t1)
{
