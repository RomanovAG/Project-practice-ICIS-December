...
//    }
    all_elements[1].L_outputs = all_elements[1].getOutput(logic_level, all_elements[1].L_inputs);
//    for (auto i = 0; i < all_elements[1].L_outputs.size(); i++)
//    {
//        cout << all_elements[1].L_outputs[i] << "\n";
//    }
}
...
//            for (auto i = 0; i < all_nets.size(); i++)
//            {
//                in.read((char *) &all_nets[i].Net_ID, sizeof (id_t));
//                in.read((char *) &all_nets[i].net_delay, sizeof (delay_t));
//                in.read((char *) &all_nets[i].start_addr, sizeof (all_nets[i].start_addr));
//                in.read((char *) &all_nets[i].end_addr, sizeof (all_nets[i].end_addr));
//            }
            return;
        }
